  ...
  try {
    ...
    if (contentType.includes("text/html")) {
      ...
      html = html.replace(/(\shref=)(["'])([^"']+)\2/g, function(_m,a,q,url) {
        ...
        try { var r = new URL(url, finalUrl).href; return r.startsWith("http") ? a+q+'/.netlify/functions/proxy?url='+encodeURIComponent(r)+q : a+q+url+q; } catch(e) { return a+q+url+q; }
      });
